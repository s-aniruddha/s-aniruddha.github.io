...
In my junior year at IIT Madras, I received the prestigious [IITM Young Research Fellowship](https://yrf.iitm.ac.in/) to work on a year-long funded research project. Through the program, I worked with [Prof. Avhishek Chatterjee](https://sites.google.com/site/avhishek1984/) from the Electrical Engineering Department on the project "Achieving near-capacity performance on queue-channel systems with waiting-time dependent errors". For my thesis project, I worked with [Prof. Balaraman Ravindran](http://www.cse.iitm.ac.in/~ravi/) from the Computer Science Department on the project "Matching options to tasks using Option Indexed Hierarchical Reinforcement Learning."
